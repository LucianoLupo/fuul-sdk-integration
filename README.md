# 🏗 Fuul Challenge implementing Scaffold-ETH 2
...
To get started with this Fuul challenge, follow the steps below:
...
I personally use Anvil from Foundry... I've a terminal always running with anvil, check [Foundry official docs](https://book.getfoundry.sh/anvil/)

```
anvil
```

but Scaffold has this other way that can be used if you want:
